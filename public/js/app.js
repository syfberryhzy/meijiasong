...
Echo.private('order.1').listen('OrderItemEvent', function (e) {
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-49780f60", Component.options)
  } else {
    hotAPI.reload("data-v-49780f60", Component.options)
' + '  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-49780f60", module.exports)
  }
}
